...
Mid Exam for Basic Programming - A simple program to generate a triangular pattern of pipe symbols based on a user-provided positive integer.
...
1.  **Clone this repository**
    ...
    ```bash
    git clone https://github.com/adiaryaz/pipe-pattern.git
    cd pipe-pattern
    ```

2.  **Run the program** (assuming the file is `PEMDAS-L4.py`):
